        ...
        if(empty($jml_data)){
            ...
            while ($data = mysqli_fetch_array($query)) {
                ...
                if($status=="None"){
                    ...
                    $tombol_opsi='<button type="button" class="btn btn-md btn-rounded btn-outline-warning" data-bs-toggle="modal" data-bs-target="#ModalBayarAngsuran" data-id="'.$id_pinjaman_angsuran.'">Bayar</span>';
                }else{
                    if($status=="Pending"){
                        $status_label='<span class="badge badge-warning">Pending</span>';
                        $tombol_opsi='<button type="button" class="btn btn-md btn-rounded btn-outline-info show_detail_pembayaran" data-id="'.$kode_pembayaran.'">Detail</span>';
                    }else{
                        if($status=="Lunas"){
