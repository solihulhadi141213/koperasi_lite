    ...
    if(empty($_POST['id_simpanan_jenis'])){
        ...
        if(empty($_POST['id_anggota'])){
            ...
            if(empty($_POST['metode_pembayaran'])){
                ...
                $ValidasiDuplikat = mysqli_num_rows(mysqli_query($Conn, "SELECT id_simpanan FROM simpanan WHERE id_simpanan_jenis='$id_simpanan_jenis' AND id_anggota='$id_anggota'"));
                if(!empty($ValidasiDuplikat)){
                    ...
                    if($InputSimpananWajib){
                        echo '
                            <input type="hidden" id="get_uuide_simpanan" value="'.$uuid_simpanan.'">
                            <div class="alert alert-success">
                                <span id="NotifikasiBayarSimpananBerhasil">Success</span>
                            </div>
                        ';
                    }else{
                        echo '
