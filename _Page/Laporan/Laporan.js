...
$('#ProsesLaporanPinjaman').submit(function(){
    var ProsesLaporanPinjaman = $('#ProsesLaporanPinjaman').serialize();
    $.ajax({
        type    : 'POST',
        url     : '_Page/Laporan/TabelLaporanPinjaman.php',
        data    : ProsesLaporanPinjaman,
        success: function(data) {
            $('#TabelLaporanPinjaman').html(data);
        }
    });
});

$('#CetakLaporanPinjaman').click(function(e) {
    e.preventDefault();
    ...
    // Serialize form data
    var formData = $('#ProsesLaporanPinjaman').serialize();
    
    // URL tujuan cetak
    var printUrl = '_Page/Laporan/CetakLaporanPinjaman.php?' + formData;
...
$('#ProsesLaporanAngsuran').submit(function(){
    var ProsesLaporanAngsuran = $('#ProsesLaporanAngsuran').serialize();
    $.ajax({
        type    : 'POST',
        url     : '_Page/Laporan/TabelLaporanAngsuran.php',
        data    : ProsesLaporanAngsuran,
        success: function(data) {
            $('#TabelLaporanAngsuran').html(data);
        }
    });
});

$('#CetakLaporanAngsuran').click(function(e) {
    e.preventDefault();
    ...
    // Serialize form data
    var formData = $('#ProsesLaporanAngsuran').serialize();
    
    // URL tujuan cetak
    var printUrl = '_Page/Laporan/CetakLaporanAngsuran.php?' + formData;
