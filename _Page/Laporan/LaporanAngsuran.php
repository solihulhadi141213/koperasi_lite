        ...
        <div class="col-lg-12 mb-4">
            <div class="card">
                <div class="card-header">
                    <form action="javascript:void(0);" id="ProsesLaporanAngsuran">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <b class="card-title">
                                    <i class="bi bi-tag"></i> Laporan Angsuran
                                </b>
                            </div>
                            ...
                            <div class="col-md-1 mb-3">
                                <button type="button" class="btn btn-md btn-secondary btn-block" id="CetakLaporanAngsuran">
                        ...
                        <table class="table table-striped table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <td align="left"><b>Tgl.Angsuran</b></td>
                                    <td align="left"><b>Tgl.Bayar</b></td>
                                    <td align="left"><b>Nama Anggota</b></td>
                                    <td align="left"><b>No.Induk</b></td>
                                    <td align="left"><b>Pokok</b></td>
                                    <td align="left"><b>Jasa</b></td>
                                    <td align="left"><b>Denda</b></td>
                                    <td align="left"><b>Jumlah</b></td>
                                </tr>
                            </thead>
                            <tbody id="TabelLaporanAngsuran">
                                <tr>
                ...
                <div class="card-footer">
                    <small>
                        Periode : <span class="text-muted" id="periode_data_laporan_angsuran">Belum Diatur</span>
                    </small>
                </div>
            </div>
        </div>
