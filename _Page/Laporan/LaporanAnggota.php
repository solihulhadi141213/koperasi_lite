        ...
        <div class="col-lg-12 mb-4">
            <div class="card">
                <div class="card-header">
                    <form action="javascript:void(0);" id="ProsesLaporanAnggota">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <b class="card-title">
                                    <i class="bi bi-tag"></i> Laporan Anggota
                                </b>
                            </div>
                            ...
                            <div class="col-md-1 mb-3">
                                <button type="button" class="btn btn-md btn-secondary btn-block" id="CetakLaporanAnggota">
                            ...
                            <thead>
                                <tr>
                                    <td align="center"><b>No</b></td>
                                     <td align="left"><b>Tanggal Masuk</b></td>
                ...
                <div class="card-footer">
                    <small>
                        Periode : <span class="text-muted" id="periode_data_laporan_anggota">Belum Diatur</span>
                    </small>
                </div>
            </div>
        </div>
