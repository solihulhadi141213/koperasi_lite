                    ...
                    <div class="row mb-3">
                        <div class="col-12 text-center">
                            <div class="alert alert-warning">
                                ...
                                <small>
                                    Dengan menghapus data permohonan penarikan dana simpanan ini, maka anda tidak akan bisa melanjutkan proses verifikasi.<br>
                ...
                echo '
                     <div class="row mb-3">
                        <div class="col-12">
                            <div class="alert alert-warning">
                                <small>
                                    Data Penarikan yang sudah melalui verifikasi tidak bisa dihapus!
                                </small>
                            </div>
                        </div>
                    </div>
